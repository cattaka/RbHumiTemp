...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { access_token: @box.access_token, created_at: @box.created_at, open: @box.open, updated_at: @box.updated_at, user_id: @box.user_id }
    end
  ...
  test "should update box" do
    patch :update, id: @box, box: { access_token: @box.access_token, created_at: @box.created_at, open: @box.open, updated_at: @box.updated_at, user_id: @box.user_id }
    assert_redirected_to box_path(assigns(:box))
  end
